...
if(startup_country_data_has_been_modify())
{
    ...
    {
        //Prendre le nom et remplacer par l'id pour faire l'insertion dans la table intermediaire
        $country = $_POST['founders_country_selectBox'][$x];
        ...
        echo('SELECT id_founders_country FROM founders_country WHERE founders_country = "'.$country.'"<br>');
        ...
        echo('INSERT INTO startup_founders_country(fk_startup, fk_founders_country) VALUES('.$param.','.$founders_country.')');
...
if(startup_impact_data_has_been_modify())
{
    ...
    {
        //Prendre le nom et remplacer par l'id pour faire l'insertion dans la table intermediaire
        $impact = $_POST['impact_sdg_selectBox'][$x];
